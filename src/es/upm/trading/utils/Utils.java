...
public class Utils {
    ...
    public static void sendRequest(Agent sender, String serviceType, Serializable content) {
        ...
        sendMessage(sender, receiver, ACLMessage.REQUEST, content);
    }
 
    /**
     * Envía un mensaje ACL de tipo REQUEST con un objeto serializable a un AID concreto.
     * Usado cuando el receptor ya se conoce (e.g. AllCoinsFetchBehaviour lo busca una vez
     * fuera del bucle y reutiliza el AID para todas las monedas).
     */
    ...
    public static void sendInform(Agent sender, AID receiver, Serializable content) {
        sendMessage(sender, receiver, ACLMessage.INFORM, content);
    }
 
    /**
     * Envía un mensaje ACL genérico.
     */
