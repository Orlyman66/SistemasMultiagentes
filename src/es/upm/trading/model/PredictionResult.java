 ...
 *  - La variación porcentual esperada entre el precio actual y el predicho
...
public class PredictionResult implements Serializable {
    ...
    public PredictionResult(String coinId, int stepsAhead, double currentPrice, double predictedPrice,
                            double confidence) {
        this.coinId = coinId;
        ...
        this.changePct = currentPrice > 0 ? (predictedPrice - currentPrice) / currentPrice * 100.0
                : 0.0;
