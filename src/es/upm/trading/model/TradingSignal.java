...
/**
 * Señal de trading generada por AgentePredictor que
...
public class TradingSignal implements Serializable {
    ...
    private String justification; // justificación de la decisión para mostrar en la UI
    private long timestamp;

    public TradingSignal(Action action, String symbol, double price, double confidence, String justification) {
        this.action = action;
        this.symbol = symbol;
        this.price = price;
